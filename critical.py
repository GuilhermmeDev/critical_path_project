...
# Dados de exemplo
data = {
    'Item': ['I','A','B','C','D','E','F','G','H','Z','J','K'],
    'Early Start': [0,1,1,1,7,7,3,4,10,8,8,16],
    'Early Finish': [0,6,2,3,16,9,4,7,14,15,13,19],
    'Late Start': [0,4,4,1,10,12,6,4,15,8,12,16],
    'Late Finish': [0,9,5,3,19,14,7,7,19,15,17,19],
    'Precedência': ['Início','I','I','I','A','A','B','C','E','F','G','Z']
}
